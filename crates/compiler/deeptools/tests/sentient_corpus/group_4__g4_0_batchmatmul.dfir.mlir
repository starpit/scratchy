func.func @dataflowProgram() attributes {grid = [1]} {
  ...
  dataflow.program_unit %16 : {
    ...
    %22 = arith.constant 393216 : index
    ...
    %27 = arith.constant 524288 : index
    ...
    %32 = arith.constant 749568 : index
    ...
    %37 = arith.constant 782336 : index
