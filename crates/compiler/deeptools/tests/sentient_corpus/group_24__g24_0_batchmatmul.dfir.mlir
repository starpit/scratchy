func.func @dataflowProgram() attributes {grid = [1]} {
  ...
  dataflow.program_unit %16 : {
    %17 = arith.constant 194560 : index
    ...
    %22 = arith.constant 4325376 : index
    ...
    %27 = arith.constant 4456448 : index
    ...
    %32 = arith.constant 1404928 : index
    ...
    %37 = arith.constant 1437696 : index
  ...
  dataflow.program_unit %15 : {
    %62 = arith.constant 194560 : index
